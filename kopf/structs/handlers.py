...
# TODO: this is not a resource handler at all! no retries, backoff, and stuff.
#       it is a web handler.
#       BUT: it can have filters.
@dataclasses.dataclass
class ResourceAdmissionHandler(ResourceHandler):
    fn: callbacks.ResourceAdmissionFn  # type clarification
    reason: Admission
