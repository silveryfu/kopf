...
async def spawn_tasks(
    ...
    # TODO: a better, purpose-driven name for the `container` variable?
    container: primitives.Container[reviews.ClientConfig] = primitives.Container()
    tasks.append(aiotasks.create_guarded_task(
        name="admission insights chain", flag=started_flag, logger=logger,
        coro=admission.condition_chain(
